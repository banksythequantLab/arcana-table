...
const CARDS = [
  ...
  { id: 'brain',   kicker: 'The mind at the table', title: 'The DM runs on <b>OpenAI</b>', sub: 'GPT with function calling, where the functions are this page&rsquo;s live WebMCP tools &mdash; and OpenAI TTS for the voice it answers in. The key lives in a Cloudflare Worker, never in your browser.' },
