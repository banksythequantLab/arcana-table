...
const CARDS = [
  ...
  { id: 'webmcp',  kicker: 'How it works', title: '20 tools on <code>document.modelContext</code>', sub: 'The built-in DM calls <code>getTools()</code> and <code>executeTool()</code> — the same contract your agent would use.' },
